    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container px-4 md:px-6 py-32">
        <div className="max-w-3xl mx-auto text-center">
          <div className="mb-8 inline-block p-8 bg-primary/10 border-2 border-primary rounded-2xl shadow-neon">
            <Construction className="h-24 w-24 text-primary mx-auto mb-6 animate-pulse" strokeWidth={2} />
          </div>
          ...
          <div className="mb-8">
            <span className="px-6 py-3 bg-accent/50 border-2 border-primary/30 text-foreground font-tech font-bold text-lg rounded-lg inline-block">
              🚧 Sezione in Costruzione 🚧
            </span>
          </div>
          
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 font-tech leading-relaxed">
            Stiamo preparando una collezione di <span className="text-primary font-bold">guide esclusive</span>, 
            <span className="text-primary font-bold"> materiali formativi</span> e <span className="text-primary font-bold">risorse digitali</span> per 
            aiutarti nella tua carriera nel gaming, tech e creative industries.
          </p>
          
          <div className="bg-card/50 backdrop-blur-sm border-2 border-primary/20 rounded-xl p-8">
